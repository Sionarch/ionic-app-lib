...
Security.addAndroidPushCredentials = function(appId, jar, profileTag, fcmServerKey) {
  return sendCredentials(appId, jar, profileTag, {
    type: 'android_push',
    api_key: fcmServerKey // eslint-disable-line camelcase
  });
};

Security.addIOSPushCredentials = function(appId, jar, profileTag, certificateFileStream,
                                      certificatePassword) {
  return sendCredentials(appId, jar, profileTag, {
    type: 'ios_push',
    cert_file: certificateFileStream, // eslint-disable-line camelcase
